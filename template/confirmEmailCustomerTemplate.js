const confirmEmailCustomer = (url) => {
    return `<!doctype html>
                          ...
                          <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                                <tbody>
                                  <tr>
                                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:100px;padding-bottom:50px;word-break:break-word;">
                                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:14px;line-height:1;text-align:center;color:#ffffff;"><span style="font-size: 21px; line-height: 21px;">Noch ein Schritt bis zur vollständigen Registrierung!</span><br /></div>
                                    </td>
                                  </tr>
                                  <tr>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" bgcolor="#fea62a" role="presentation" style="border:none;border-radius:24px;cursor:auto;mso-padding-alt:10px 25px;background:#fea62a;" valign="middle">
                                              <a href=${url} style="display:inline-block;background:#fea62a;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:24px;" target="_blank"> E-Mail Adresse bestätigen </a>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
...
module.exports = confirmEmailCustomer;