const confirmEmailAdvertiser = (url) => {
    return `<!doctype html>
    ...
    <body style="word-spacing:normal;background-color:#d7dde5;">
      <div style="background-color:#d7dde5;">
        <table align="center" background="https://res.cloudinary.com/ds7kynxmg/image/upload/v1630154480/imgs/vhjrkdgakyqyqbsq2eem.jpg" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:url('https://res.cloudinary.com/ds7kynxmg/image/upload/v1630154480/imgs/vhjrkdgakyqyqbsq2eem.jpg') center top / cover no-repeat;background-position:center top;background-repeat:no-repeat;background-size:cover;width:100%;">
          <tbody>
            <tr>
              <td>
                <!--[if mso | IE]><v:rect style="mso-width-percent:1000;" xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false"><v:fill origin="0, -0.5" position="0, -0.5" src="https://res.cloudinary.com/ds7kynxmg/image/upload/v1630154480/imgs/vhjrkdgakyqyqbsq2eem.jpg" type="frame" size="1,1" aspect="atleast" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0"><table align="center" border="0" cellpadding="0" cellspacing="0" class="" role="presentation" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
...
module.exports = confirmEmailAdvertiser;